...
$lang = array_merge($lang, array(
	...
	'MAILINGLIST_LISTENEREMAIL'			=> 'Mailing list listener email',
	'MAILINGLIST_LISTENEREMAIL_EXPLAIN'		=> 'Specify the mailinglist listener email account that posts from the mailing list to this PHPBB forum. This prevents the extension from sharing posts that are already from the mailing list.',
