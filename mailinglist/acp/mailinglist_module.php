...
class mailinglist_module
{
	...
	function main($id, $mode)
	{
		...
		$mailinglist_listeneremail = $this->request->variable('mailinglist_listeneremail', $this->config['mailinglist_listeneremail']);
		...
		if ($this->request->is_set_post('submit'))
		{
			...
			$this->config->set('mailinglist_listeneremail', $mailinglist_listeneremail);
		...
		$template->assign_vars(array(
			...
			'S_MAILINGLIST_LISTENEREMAIL'			=> $mailinglist_listeneremail,
